...
"""
Baseline 4: XGBoost
State-of-art gradient boosting for tabular data
"""
...
class XGBoostModel:
    """XGBoost model for crime prediction"""
...
def main():
    print("="*70)
    print("BASELINE 4: XGBOOST MODEL")
    print("="*70)
    ...
    # Print summary
    evaluator.print_summary(metrics, "XGBoost")
    ...
    # Save results
    pred_file = RESULTS_DIR / "model_predictions" / "xgboost_predictions.json"
    ...
    metrics_file = RESULTS_DIR / "fairness_metrics" / "xgboost_fairness.json"
    metrics_file.parent.mkdir(exist_ok=True)
    evaluator.save_metrics(metrics, str(metrics_file))
    
    # Save feature importance
    importance_file = RESULTS_DIR / "feature_importance" / "xgboost_features.csv"
